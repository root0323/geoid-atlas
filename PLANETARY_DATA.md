...
이 웹의 수성·금성·화성·달 기준면은 NASA PDS의 실제 수치 자료를 사용합니다. 지형 모델이나 색상 이미지에서 추정한 값이 아닙니다. 지구의 기존 관측·KN18·EGM2008 비교 자료는 수정하지 않았습니다. 가상 소행성과 지구의 전 지구 구체는 여전히 개념 모형입니다.
